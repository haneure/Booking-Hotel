...
void userinput(struct bookr **pala, struct bookr **ini, struct bookr **ekor, struct bookv **head, struct bookv **curr, struct bookv **tail, struct bookr **titik, struct bookv **node, int *choice, struct Queue **mae, struct Queue **queue)
{
    ...
    if(pilihan==1){
            ...
            else if(*choice==2)                                                     //Menu untuk ruang booking VIP
            {
                ...
                printf("VIP");
                printf("\nTambahan Fitur Kamar :");
                printf("\n1. Bathtub + Twin Bed + TV + Breakfast(Superior) = 1.000.000");
                printf("\n2. Bathtub + Queen Bed + TV + Breakfast + Dinner (Superior) = 1.200.000");
                printf("\n3. Bathtub + King Bed + TV + Breakfast + Lunch + Dinner(Deluxe) = 1.400.000");
                printf("\nPilihan : ");
                scanf("%d", &tipe);
                fflush(stdin);
                if(tipe==1)
        ...
        while(1) //looping untuk menampilkan bookingan kamar hotel tipe reguler
        {
            ...
            }else if(pilihan2==3)
            {
                    ...
                    if(strcmp((*ini)->kodebook, password)== 0) //Pengecekan kode booking untuk membatalkan booking agar yang bisa membatalkan hanya yang memesan
                    {
                        ...
                        while((*ini) != temp){
                            if(strcmp(temp->nama, (*ini)->nama) == 0){              //proses delete dari database.txt
                                (*ini) = (*ini);                                    //jika nama yang dibandingkan sama, maka diskip atau tidak ditulis di database.txt
                            } else{
                ...
                while(1){
                    ...
                    printf("2. Cari berdasarkan kode booking\n");
                    printf("3. Exit\n");
        ...
        while(1) //looping untuk menampilkan bookingan kamar hotel tipe VIP
        {
            ...
            }else if(pilihan2==3)
            {
                ...
                while(1){
                    ...
                    int found = 0;
                    system("cls");
                    printf("Menu Cari kamar\n");                              //Searching berdasarkan nama dan kode booking
                    printf("1. Cari berdasarkan nama\n");
                    printf("2. Cari berdasarkan kode booking\n");
                    printf("3. Exit\n");
                    printf("Pilihan: "); scanf("%d", &srcchoice);
...
//----------------------File processing reading dari file.txt, untuk database Reguler------------------------
        ...
        if(fp != NULL){
            while(1){
                fscanf(fp, " %[^#]#%d#%d#%d-%d-%d-Rp.%d-%[^\n]", &nama, &no, &durasi, &date, &month, &year, &price, kodebook);
                if(feof(fp)){
                    break;
                }
                sizer++;
...
//----------------------File processing reading dari file.txt, untuk database VIP------------------------
        ...
        printf("Fasilitas: Bathtub + Twin Bed + TV + Breakfast(Superior)\n");
        printf("Tipe 2: Rp. 1.200.000 / hari\n");
        printf("Fasilitas: Bathtub + Queen Bed + TV + Breakfast + Dinner (Superior)\n");
        printf("Tipe 3: Rp. 1.400.000 / hari\n");
        printf("Fasilitas: Bathtub + King Bed + TV + Breakfast + Lunch + Dinner(Deluxe)\n");
        printf("\n");
        ...
        switch(choice){       //Switch case pilihan menu
            ...
            case 2:
                ...
                if(pilihan==1)      //untuk kamar reguler
                {
                    ...
                    {
                        struct bookr *ptr = HashT[0];
                        struct bookr *ptr1 = HashT[1];
                        struct bookr *ptr2 = HashT[2];
                        fitur = 0;
                        system("cls");
                ...
                else if (pilihan==2)                //untuk kamar vip
                {
                    ...
                    do
                    {
                        ...
                        {
                            if(strcmp(curr->kodebook, current->left->kode)==0)                                      //print fitur kamar sesuai dengan tree left, middle, atau right yang sudah ditentukan berdasarkan harga kamar
                            {
                                printf("Bathtub + Twin Bed + TV + Breakfast(Superior) = 1000000");
                                check = 1;
                                break;
                            }else
                            {
                        ...
                        if(check==0)
                        {
                            ...
                            while(current->middle!=NULL)
                            {
                                ...
                                {
                                    printf("Bathtub + Queen Bed + TV + Breakfast + Dinner (Superior) = 1200000");
                                    check=1;
                                    break;
                                }else
                                {
                        ...
                        if(check==0)
                        {
                            ...
                            while(current->right!=NULL)
                            {
                                ...
                                {
                                    printf("Bathtub + King Bed + TV + Breakfast + Lunch + Dinner(Deluxe) = 1400000");
                                    check=1;
                                    break;
                                }else
                                {
